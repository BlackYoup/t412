...
<?php } elseif (!empty($t411->error)) { ?>
    ...
    <div class="jumbotron">
      ...
      <p>Les serveurs de <a href="https://www.t411.ai">T411</a> mettent trop de temps à répondre. Pensez à vérifier <a href="http://irc.t411.ai/ip/index.php">l'état du tracker</a>.</p>
    </div>
